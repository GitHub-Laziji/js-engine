...
public class LambdaWordNode extends BasePlanNode implements WordNode {
    ...
    protected List<BiFunction<Node, Node, Node>> getPlan() {
        return Arrays.asList((self, pre) -> new ProxyNode<>(this, new FunctionParamsInternalNode(null), new NameWordNode(null)), (self, pre) -> new UnitNode(this, Token.LAMBDA), (self, pre) -> new ProxyNode<>(this, new BigBracketParagraphNode(null), new ProxySentenceNode(null)));
    }
